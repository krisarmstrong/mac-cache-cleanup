...
# Quits Outlook, clears its Caches + WebKit data, relaunches it. Daily 06:00.
...
HOME_DIR="${HOME}"
LABEL="com.krisarmstrong.clearoutlookcache"
...
echo "  Watch log:  tail -f $LOGS_DIR/clear-outlook-cache.log"
